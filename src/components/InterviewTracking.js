...
function InterviewTracking() {
      ...
      <div>
        ...
        <div className="flex-container">
          <div className="left-column">
            ...
            {trackingData.upcomingInterviews.length > 0 ? (
              trackingData.upcomingInterviews.map((candidate) => (
                <div key={candidate._id} className="upcoming-card">
                  <div className="upcoming-header">
                    <div className="upcoming-name">{candidate.name}</div>
                  ...
                  <div className="candidate-link-container">
                    <Link
                      to={`/candidates/${candidate._id}`}
          ...
          <div className="right-column">
            ...
            {trackingData.recentlyUpdated.map((candidate) => (
              <div key={candidate._id} className="recent-card">
                <div className="recent-card-name">{candidate.name}</div>
          ...
          {trackingData.stageCounts.map((stage) => (
            ...
            >
              <div className="stage-header">
                <div className="stage-title">{stage._id}</div>
  ...
  return (
    <div className="interview-tracking">
      <div className="interview-tracking__header">
        <h2 className="interview-tracking__title">
          <FontAwesomeIcon icon={faUserTie} /> Interview Tracking
        </h2>
      </div>

      {/* Tabs */}
      <div className="interview-tracking__tabs">
        <div
          className={`interview-tracking__tab ${
            activeTab === 'overview' ? 'interview-tracking__tab--active' : ''
          }`}
          onClick={() => setActiveTab('overview')}
        >
          <FontAwesomeIcon icon={faChartBar} /> Overview
        ...
        <div
          className={`interview-tracking__tab ${
            activeTab === 'stages' ? 'interview-tracking__tab--active' : ''
          }`}
          onClick={() => setActiveTab('stages')}
        >
          <FontAwesomeIcon icon={faListAlt} /> Candidates by Stage
      ...
      {loading ? (
        ...
        <div className="loading-container">
          ...
          />
          <p>{error}</p>
          <button className="retry-button" onClick={fetchTrackingData}>
            Retry
          </button>
        </div>
      ) : (
